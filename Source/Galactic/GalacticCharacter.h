...
#include "Engine.h" // Added engine access - LS 2/24/23
...
public:
	...
	TSubclassOf<class APaintball_StoughtonProjectile> ProjectileClass;
...
*/
public: 
	virtual void Tick(float DeltaSeconds) override;	// Changed deltatime to deltaseconds to include shaders - LS 2/24/23
	UPROPERTY()
		AFogActor* m_fog;

/*
Added Plugin Shader - LS 2/24/23
*/
public:
